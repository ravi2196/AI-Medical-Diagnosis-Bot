...
#         stemmed_symptom = stemmer.stem(symptom.lower())
#         if stemmed_symptom in symptom_columns:
#             index = list(symptom_columns).index(stemmed_symptom)
...
#     symptoms_vector = encode_symptoms(symptoms_list, symptom_columns)
